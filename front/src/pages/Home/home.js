      ...
      <div className="home-container" style={{'display': 'flex', padding: '20px', alignItems:'flex-start'}}>
        ...
        <div className="statistics-container" style={{width:'40%', alignSself: 'flex-start'}}>
          ...
          <div className="StatisticBox" style={{ display: 'flex', flexWrap: 'wrap', justifyContent:'center' }}> 
            ...
            <StatisticBox icon={getImageByName('pileOfSweaters')} label="complete projects" value={completedCount} onClick={() => handleNavigate('/projects', 2)}/>
            <StatisticBox icon={getImageByName('openBook')} label="ongoing projects" value={ongoingCount} onClick={() => handleNavigate('/projects', 1)}/>
          </div>
        </div>
